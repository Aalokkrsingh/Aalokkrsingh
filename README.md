...
|---|---|---|
| ETL / ELT Pipelines | Exploratory Data Analysis | Computer Vision |
| Data Warehouses | Business Analytics | Machine Learning |
| Data Modeling | Power BI Dashboards | AI Projects |
| SQL Analytics | Financial Analytics | Edge / Raspberry Pi |
...
### Data Engineering
`ETL` `Data Warehousing` `Data Modeling` `Apache Spark` `PySpark`
...
### Building with data. Learning continuously. Engineering with purpose.
